...
class WeatherTracker(QMainWindow):
    ...
    def _on_read_csv(self):
        ...
        try:
            ...
            self.status.setText(f"✅ Loaded {len(self.df)} rows from {os.path.basename(path)}")
        except NotImplementedError:
    ...
    def _on_write_csv(self):
        ...
        try:
            ...
            self.status.setText(f"✅ Saved CSV: {os.path.basename(path)}")
        except NotImplementedError:
    ...
    def _on_write_json(self):
        ...
        try:
            ...
            self.status.setText(f"✅ Saved JSON: {os.path.basename(path)}")
        except NotImplementedError:
